...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IBlogCategoryService
    {
        ...
        /// </returns>
        Task<IList<BlogCategory>> GetAllCategoriesAsync(int storeId = 0, bool showHidden = false);
        ...
        /// The task result contains the categories
        /// </returns>
        Task<IPagedList<BlogCategory>> GetAllCategoriesAsync(string categoryName, int storeId = 0,
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteProductCategoryAsync(BlogCategoryBlogPost productCategory);
        ...
        /// </returns>
        Task<IPagedList<BlogCategoryBlogPost>> GetProductCategoriesByCategoryIdAsync(int categoryId,
        ...
        /// </returns>
        Task<IList<BlogCategoryBlogPost>> GetProductCategoriesByProductIdAsync(int productId, bool showHidden = false);
        ...
        /// </returns>
        Task<BlogCategoryBlogPost> GetProductCategoryByIdAsync(int productCategoryId);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertProductCategoryAsync(BlogCategoryBlogPost productCategory);
        ...
        /// <param name="productCategory">>Product category mapping</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task UpdateProductCategoryAsync(BlogCategoryBlogPost productCategory);
        ...
        BlogCategoryBlogPost FindProductCategory(IList<BlogCategoryBlogPost> source, int productId, int categoryId);
