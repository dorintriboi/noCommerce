...
namespace Nop.Services.Catalog
{
    ...
    public partial class BlogCategoryService : IBlogCategoryService
    {
        ...
        private readonly IRepository<BlogPost> _productRepository;
        ...
        public BlogCategoryService(
            ...
            IRepository<BlogPost> productRepository,
        ...
        /// </returns>
        protected virtual async Task<IList<BlogCategoryBlogPost>> GetProductCategoriesByProductIdAsync(int productId, int storeId,
        ...
        /// </returns>
        protected virtual async Task<IList<BlogCategory>> SortCategoriesForTreeAsync(IList<BlogCategory> source, int parentId = 0,
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task DeleteCategoryAsync(BlogCategory category)
        {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task DeleteCategoriesAsync(IList<BlogCategory> categories)
        {
            if (categories == null)
        ...
        /// The task result contains the categories
        /// </returns>
        public virtual async Task<IPagedList<BlogCategory>> GetAllCategoriesAsync(string categoryName, int storeId = 0,
        ...
        /// The task result contains the categories
        /// </returns>
        public virtual async Task<IList<BlogCategory>> GetAllCategoriesByParentCategoryIdAsync(int parentCategoryId,
            bool showHidden = false)
        {
        ...
        /// The task result contains the categories
        /// </returns>
        public virtual async Task<IList<BlogCategory>> GetAllCategoriesDisplayedOnHomepageAsync(bool showHidden = false)
        {
        ...
        /// </returns>
        public virtual async Task<BlogCategory> GetCategoryByIdAsync(int categoryId)
        {
        ...
        /// </returns>
        public virtual async Task<IPagedList<BlogCategory>> GetCategoriesByAppliedDiscountAsync(int? discountId = null,
        ...
        /// <param name="category">Category</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task InsertCategoryAsync(BlogCategory category)
        {
        ...
        /// <param name="category">Category</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task UpdateCategoryAsync(BlogCategory category)
        {
            if (category == null)
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task DeleteProductCategoryAsync(BlogCategoryBlogPost productCategory)
        {
        ...
        /// </returns>
        public virtual async Task<IPagedList<BlogCategoryBlogPost>> GetProductCategoriesByCategoryIdAsync(int categoryId,
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            if (categoryId == 0)
                return new PagedList<BlogCategoryBlogPost>(new List<BlogCategoryBlogPost>(), pageIndex, pageSize);
        ...
        /// The task result contains the product category mapping collection
        /// </returns>
        public virtual async Task<IList<BlogCategoryBlogPost>> GetProductCategoriesByProductIdAsync(int productId, bool showHidden = false)
        {
            var store = await _storeContext.GetCurrentStoreAsync();
        ...
        /// </returns>
        public virtual async Task<BlogCategoryBlogPost> GetProductCategoryByIdAsync(int productCategoryId)
        {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task InsertProductCategoryAsync(BlogCategoryBlogPost productCategory)
        {
        ...
        /// <param name="productCategory">>Product category mapping</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task UpdateProductCategoryAsync(BlogCategoryBlogPost productCategory)
        {
        ...
        public virtual async Task<IDictionary<int, int[]>> GetProductCategoryIdsAsync(int[] productIds)
        {
            ...
            return (await query.Where(p => productIds.Contains(p.BlogId))
                .Select(p => new { p.BlogId, p.CategoryId })
                .ToListAsync())
                .GroupBy(a => a.BlogId)
        ...
        /// The task result contains the categories
        /// </returns>
        public virtual async Task<IList<BlogCategory>> GetCategoriesByIdsAsync(int[] categoryIds)
        {
        ...
        public virtual BlogCategoryBlogPost FindProductCategory(IList<BlogCategoryBlogPost> source, int productId, int categoryId)
        {
            foreach (var productCategory in source)
                if (productCategory.BlogId == productId && productCategory.CategoryId == categoryId)
        ...
        /// </returns>
        public virtual async Task<IList<BlogCategory>> GetCategoryBreadCrumbAsync(BlogCategory category, IList<BlogCategory> allCategories = null, bool showHidden = false)
        {
            if (category == null)
                throw new ArgumentNullException(nameof(category));
