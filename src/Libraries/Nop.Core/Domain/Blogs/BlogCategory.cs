...
namespace Nop.Core.Domain.Blogs
{
    ...
    /// </summary>
    public partial class BlogCategory : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountCategoryMapping>, ISoftDeletedEntity
    {
        /// <summary>
