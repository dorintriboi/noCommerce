...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class BlogCategoryController : BaseAdminController
    {
        ...
        public BlogCategoryController(IAclService aclService,
        ...
        protected virtual async Task SaveCategoryAclAsync(BlogCategory category, BlogCategoryModel model)
        {
        ...
        protected virtual async Task SaveStoreMappingsAsync(BlogCategory category, BlogCategoryModel model)
        {
